...
class MongoConnectPYN{
	var $conn;
function __construct($d){
	$this->conn = NULL;
		if(!defined("MONGO_DATABASE_NAME")){define("MONGO_DATABASE_NAME","pyn");}
	try{
   ...
   function go($d){
		if(is_null($this->conn)){
			$this->conn = new MongoConnectPYN($d);
		}
...
Class MYclass extends MongoConnectPYN{
...
$n->doit(array('firstname'=>'yatendra'));
$n->flist(array());